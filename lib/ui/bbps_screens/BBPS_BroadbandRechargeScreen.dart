...
class BBPSBroadbandRechargeScreen extends StatefulWidget {
  @override
  _BBPSBroadbandRechargeScreenState createState() =>
      _BBPSBroadbandRechargeScreenState();
}

class _BBPSBroadbandRechargeScreenState
    extends State<BBPSBroadbandRechargeScreen> {
  String? jwt_token = "";
  String? authToken = "";
  ...
  void fetchBroadbandBillers() {
    HTTPService().fetchBBPSBillers(authToken!, '1').then((response) {
      if (response.statusCode == 200) {
