...
class HTTPService {
  ...
  Future<http.Response> updateBankDetails(String authToken, String? bankName,
    ...
    print('Requesting Bank details change');
    print('Auth Token : ' + authToken.toString());
    print('Bank Name : ' + bankName.toString());
    print('Account Number : ' + accountNumber.toString());
    print('IFSC code : ' + ifsc.toString());
    print('Account Holder Name : ' + holderName.toString());
    http.Response response = await http.post(
